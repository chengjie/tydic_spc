package com.tydic.spc.web;

import com.tydic.spc.util.StringUtils;
...
public class PageContext {
    ...
    public static String root() {
        ...
        return StringUtils.removeEnd(root, "/");
    }
    ...
    public static boolean isEmpty(String paramName) {
        return StringUtils.isBlank(getRequest().getParameter(paramName));
    }
    ...
    public static String getParameter(String name) {
        return StringUtils.defaultIfEmpty(getRequest().getParameter(name), "");
    }
    ...
    public static String getUserAgent() {
        ...
        return StringUtils.replaceStr(user_agent, "", "$", "\n", " ", "\"", "\r");
    }
    ...
    public static boolean isLocalhost() {
        return getRequest().getRequestURL().toString().contains("localhost")
                || getRequest().getRequestURL().toString().contains("192.168.39.102");
    }
    ...
    public static String getClientAddress() {
        ...
        if (address != null && StringUtils.isIpAddress(address)) {
            return address;
        }
